...
(function () {
    ...
    function reviews () {
      $(function () {
        var owl = $('.owl-carousel.reviews-slider');
        var centeredBig;
        var centeredSmall;

        function checkTypeOfCentered() {
        ...
        owl.on('initialized.owl.carousel', function (event) {
          ...
          if (centeredBig) {
            var current = document.querySelector('.owl-carousel.reviews-slider .owl-item.center');
            var child = current.querySelector('.reviews-slider__item-wrap');
            $('.slide').html(child.dataset.id);
            $('.all-slides').html(event.item.count);
          } else if (centeredSmall) {
            var current = document.querySelector('.owl-carousel.reviews-slider .owl-item.active');
            var child = current.querySelector('.reviews-slider__item-wrap');
            $('.slide').html(child.dataset.id);
            $('.all-slides').html(event.item.count);
          }
        ...
        var settings = {
          ...
          smartSpeed: 1000,
          slideBy: 1,
          navText: ['<span class="slider-button slider-button-prev"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="18" viewBox="0 0 11 18"><defs><linearGradient id="8ukla" x1="5.02" x2="6.01" y1="0" y2="18.01" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#0074c3"/><stop offset="1" stop-color="#0074c3"/></linearGradient></defs><g><g><path fill="#fff" d="M8.944 17.687L.373 9.8.37 9.798a1.055 1.055 0 0 1 0-1.579L8.944.33a1.287 1.287 0 0 1 1.715 0 1.054 1.054 0 0 1 0 1.579l-7.716 7.1 7.716 7.101a1.053 1.053 0 0 1 0 1.577 1.287 1.287 0 0 1-1.715 0z"/><path fill="url(#8ukla)" d="M8.944 17.687L.373 9.8.37 9.798a1.055 1.055 0 0 1 0-1.579L8.944.33a1.287 1.287 0 0 1 1.715 0 1.054 1.054 0 0 1 0 1.579l-7.716 7.1 7.716 7.101a1.053 1.053 0 0 1 0 1.577 1.287 1.287 0 0 1-1.715 0z"/></g></g></svg></span>', '<span class="slider-button slider-button-next"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="18" viewBox="0 0 11 18"><defs><linearGradient id="u26ha" x1="4.99" x2="5.98" y1="-.02" y2="17.99" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#0074c3"/><stop offset="1" stop-color="#0074c3"/></linearGradient></defs><g><g><path fill="#fff" d="M2.055.308l8.573 7.889a1.055 1.055 0 0 1 0 1.579l-8.573 7.889a1.287 1.287 0 0 1-1.715 0 1.053 1.053 0 0 1 0-1.577l7.716-7.102L.34 1.885a1.053 1.053 0 0 1 0-1.577 1.285 1.285 0 0 1 1.715 0z"/><path fill="url(#u26ha)" d="M2.055.308l8.573 7.889a1.055 1.055 0 0 1 0 1.579l-8.573 7.889a1.287 1.287 0 0 1-1.715 0 1.053 1.053 0 0 1 0-1.577l7.716-7.102L.34 1.885a1.053 1.053 0 0 1 0-1.577 1.285 1.285 0 0 1 1.715 0z"/></g></g></svg></span>'],
          responsive: {
            0: {
              margin: 20
            },
        ...
        window.addEventListener('resize', checkTypeOfCentered);
        ...
        var reviewsLetterContent = $('.reviews-letter__content');
        var reviewsLetterBtn = $('.reviews-letter__btn');
        var modalToggle = $('.modal-toggle');
        var reviewsForm = $('.reviews-form');
        var reviewsFormTextarea = document.querySelector('.reviews-form__textarea');
        var reviewsInput = $('.reviews-input');
        var reviewsLetterModal = $('.reviews-letter__modal');
        reviewsLetterBtn.click(function (e) {
          e.preventDefault();
          reviewsLetterContent.hide();
          reviewsForm.addClass('show');
        });
        reviewsFormTextarea.value = '';
        reviewsInput.val('');
        reviewsFormTextarea.addEventListener('input', function () {
          if (this.value.length > 0) {
            this.classList.add('o-auto');
          } else {
            this.classList.remove('o-auto');
          }
        });
        reviewsForm.submit(function (e) {
          e.preventDefault();
          reviewsLetterModal.fadeIn(function () {
            setTimeout(function () {
              reviewsLetterModal.fadeOut();
              reviewsInput.val('');
              reviewsForm.removeClass('show');
              reviewsLetterContent.fadeIn();

              for (var i = 0; i < 5; i++) {
                starsWrap[i].classList.remove('filled');
                starsWrap[i].classList.add('first-filled');
                starsWrap[i].addEventListener('mouseover', listener);
              }
            }, 2000);
          });
        });
      });
      var starRating = document.querySelector('.reviews-form__star-rating');
      var starsWrap = document.querySelectorAll('.reviews-form__star');

      function listener() {
        var id = Number(this.dataset.star);

        for (var i = 0; i < 5; i++) {
          starsWrap[i].classList.remove('first-filled');

          if (starsWrap[i].dataset.star <= id) {
            starsWrap[i].classList.add('filled');
          } else {
            starsWrap[i].classList.add('not-filled');
            starsWrap[i].classList.remove('filled');
          }
        }
      }

      for (var i = 0; i < starsWrap.length; i++) {
        //  starsWrap[i].addEventListener('mouseover', listener)
        starsWrap[i].addEventListener('click', function () {
          var id = Number(this.dataset.star);

          for (var i = 0; i < 5; i++) {
            starsWrap[i].removeEventListener('mouseover', listener);
      ...
      //       var id = Number(event.target.parentNode.dataset.star);
      //       for (var i = 0; i < id; i++) {
      //       }
      //     }
      //   })
    ...
    function imgReviews () {
      $(function () {
        $(".owl-carousel.owl-carousel--2").owlCarousel({
          ...
          nav: true,
          loop: true,
          navText: ['<span class="prev img-reviews__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" viewBox="0 0 40 28"><g><g><path d="M0 13h.519L11.435.149l1.414 1.412L3.134 13H40v2H3.138l9.711 11.433-1.414 1.416L.523 15H0z"/></g></g></svg></span>', '<span class="next img-reviews__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" viewBox="0 0 40 28"><g><g><path d="M0 13h.519L11.435.149l1.414 1.412L3.134 13H40v2H3.138l9.711 11.433-1.414 1.416L.523 15H0z"/></g></g></svg></span>'],
          responsive: {
            0: {
              items: 1
            },
    ...
    var banner = (function () {
      $(document).ready(function () {
        ...
        function toggleBanner() {
          var banner = $('.banner');
          var topForm = $('.first-screen .main__form');
          var centralForm = $('.attention .attention__content');
          var bottomForm = $('.last-block .main__form');
          var actionBlock = $('.header-banner');
          var bannerHeight = banner.outerHeight();
          var bankFixed = $('.bankFixed');

          if (!checkVisibility(topForm) && !checkVisibility(centralForm) && !checkVisibility(bottomForm) && !checkVisibility(actionBlock)) {
            banner.fadeIn(); // $('.promo__pay').css({"bottom":  $(".wPopup").outerHeight()});

            bankFixed.css({
              '-webkit-transform': "translateY(-".concat(bannerHeight - 1, "px)"),
              '-moz-transform': "translateY(-".concat(bannerHeight - 1, "px)"),
              '-ms-transform': "translateY(-".concat(bannerHeight - 1, "px)"),
              '-o-transform': "translateY(-".concat(bannerHeight - 1, "px)"),
              'transform': "translateY(-".concat(bannerHeight - 1, "px)")
            });
          } else {
            banner.fadeOut(); // $('.promo__pay').css({"bottom":  0});
...
function resizeHeight2() {
  let mainbHeight = $('.main-banner').css('height');
  console.log(mainbHeight);
  

  $('.banner').css('bottom', mainbHeight);

  
}

$(document).ready(resizeHeight2);
window.addEventListener('resize', resizeHeight2);
